...
- **[frappe/agent](https://github.com/frappe/agent)** - Works with https://github.com/frappe/press (4 days ago)
...
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(impersonate-icon): Add flex-row to parent container](https://github.com/frappe/press/pull/5489)** - today
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(uptime-chart): Set max-width to 1rem](https://github.com/frappe/press/pull/5421)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(uptime-chart): Set max-width to 1rem](https://github.com/frappe/press/pull/5420)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(release-group): Fix older releases not getting selected](https://github.com/frappe/press/pull/5406)** - 3 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(release-group): Prevent empty IN array clause in SQL](https://github.com/frappe/press/pull/5400)** - 3 days ago
