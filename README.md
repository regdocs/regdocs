...
- [frappe/press @ v0.18.1](https://github.com/frappe/press/releases/tag/v0.18.1) (today)
- [frappe/frappe @ v15.106.0](https://github.com/frappe/frappe/releases/tag/v15.106.0) (2 days ago)
- [frappe/helpdesk @ v1.22.2](https://github.com/frappe/helpdesk/releases/tag/v1.22.2) (2 days ago)
...
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(uptime-chart): Replace tooltip text with a shorter message](https://github.com/frappe/press/pull/6212)** - 1 day ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(site-analytics): Fix argument and site uptime](https://github.com/frappe/press/pull/6211)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(dedicated-server-plan): Add site action to enable performance mode](https://github.com/frappe/press/pull/6166)** - 6 days ago
