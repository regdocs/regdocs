...
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(site-analytics): Change last 24 hours label to last day](https://github.com/frappe/press/pull/4767)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[Revert "fix(site-analytics): Change last 24 hours label to last day (backport #4753)"](https://github.com/frappe/press/pull/4766)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(server-analytics): Add missing start, end arguments](https://github.com/frappe/press/pull/4763)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(site-analytics): Change last 24 hours label to last day](https://github.com/frappe/press/pull/4753)** - 3 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(analytics): Fix call syntax to get_additional_duration_reports](https://github.com/frappe/press/pull/4751)** - 3 days ago
