...
- [frappe/press @ v0.9.3](https://github.com/frappe/press/releases/tag/v0.9.3) (1 day ago)
- [frappe/frappe @ v16.14.0](https://github.com/frappe/frappe/releases/tag/v16.14.0) (3 days ago)
...
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(uptime-chart): Update promql query to support empty data points](https://github.com/frappe/press/pull/6076)** - today
- [frappe/press](https://github.com/frappe/press) ➔ **[feat(plans): Show site plan based on price of dedicated server plan](https://github.com/frappe/press/pull/6032)** - 5 days ago
