...
- [frappe/helpdesk @ v1.22.1](https://github.com/frappe/helpdesk/releases/tag/v1.22.1) (today)
- [frappe/frappe @ v15.103.3](https://github.com/frappe/frappe/releases/tag/v15.103.3) (today)
- [frappe/press @ v0.8.0](https://github.com/frappe/press/releases/tag/v0.8.0) (1 day ago)
...
- [frappe/press](https://github.com/frappe/press) ➔ **[fix(readme): Fix Frappe Cloud logo](https://github.com/frappe/press/pull/5980)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[feat(actions-tab): Add query param action trigger](https://github.com/frappe/press/pull/5979)** - 2 days ago
- [frappe/press](https://github.com/frappe/press) ➔ **[feat(bench-dependencies-tab): Add article link for APT dependencies](https://github.com/frappe/press/pull/5967)** - 5 days ago
